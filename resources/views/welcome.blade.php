...
@section('content')
<div style="text-align: center; width: 90%; max-width: 700px; margin:auto; background: rgba(0, 0, 0, 0, 0.85); padding: 30px; border-radius: 15px; border: 3px solid #ff8c00; box-shadow: 0 0 10px #ff8c00;">
